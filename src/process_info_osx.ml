...
let ri_child_pkg_idle_wkups =
  field rusage_info_v3 "ri_child_pkg_idle_wkups" uint64_t

let ri_child_interrupt_wkups =
...
type t =
  {user_time: Time_ns.Span.t; system_time: Time_ns.Span.t; memory_size: int64}
[@@deriving sexp]
